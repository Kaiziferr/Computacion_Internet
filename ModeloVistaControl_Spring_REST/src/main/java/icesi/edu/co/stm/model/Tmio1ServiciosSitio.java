...
public class Tmio1ServiciosSitio implements Serializable {
	...
	public Tmio1BusDriver getTmio1Conductore() {
		return this.tmio1Conductore;
	}

	public void setTmio1Conductore(Tmio1BusDriver tmio1Conductore) {
		this.tmio1Conductore = tmio1Conductore;
	}

	public Tmio1Route getTmio1Ruta() {
		return this.tmio1Ruta;
	}

	public void setTmio1Ruta(Tmio1Route tmio1Ruta) {
